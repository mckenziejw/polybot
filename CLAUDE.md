...
For numerical/mathematical implementations, validate against a known reference implementation or test case before presenting as complete. Use established formulations (e.g., Numerical Recipes) rather than deriving from scratch.
